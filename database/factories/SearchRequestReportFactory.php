...
/**
 * @extends Factory<SearchRequestReport>
 */
class SearchRequestReportFactory extends Factory
{
    protected $model = SearchRequestReport::class;
    ...
    public function definition(): array
    {
        ...
        return [
            'search_request_id' => SearchRequest::query()->inRandomOrder()->value('id'),
            'agent_id' => $agentId,
